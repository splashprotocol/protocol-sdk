...
test('it should create asset amount object valid instance', () => {
  const adaAssetAmount = Currency.new(1n, AssetInfo.ada);

  expect(adaAssetAmount).toBeInstanceOf(Currency);
  expect(adaAssetAmount.amount).toBe(1n);
  expect(adaAssetAmount.asset).toBe(AssetInfo.ada);
});

test('it should sum 2 asset amounts', () => {
  const adaAssetAmount1 = Currency.new(1n, AssetInfo.ada);
  const adaAssetAmount2 = Currency.new(3n, AssetInfo.ada);
...
test('it should throws error on sum method', () => {
  const adaAssetAmount1 = Currency.new(1n, AssetInfo.ada);
  const adaAssetAmount2 = Currency.new(3n, AssetInfo.spf);
...
test('it should returns true on gte method', () => {
  const adaAssetAmount1 = Currency.new(1n, AssetInfo.ada);
  const adaAssetAmount2 = Currency.new(1n, AssetInfo.ada);
...
test('it should return false for isPositive with amount = 0', () => {
  const adaAssetAmount = Currency.new(0n, AssetInfo.ada);
