...
test('it should create asset amount object valid instance', () => {
  const adaAssetAmount = Currency.new(1n, adaAssetInfo);

  expect(adaAssetAmount).toBeInstanceOf(Currency);
  expect(adaAssetAmount.amount).toBe(1n);
  expect(adaAssetAmount.asset).toBe(adaAssetInfo);
});

test('it should sum 2 asset amounts', () => {
  const adaAssetAmount1 = Currency.new(1n, adaAssetInfo);
  const adaAssetAmount2 = Currency.new(3n, adaAssetInfo);
...
test('it should throws error on sum method', () => {
  const adaAssetAmount1 = Currency.new(1n, adaAssetInfo);
  const adaAssetAmount2 = Currency.new(3n, spfAssetInfo);
...
test('it should returns true on gte method', () => {
  const adaAssetAmount1 = Currency.new(1n, adaAssetInfo);
  const adaAssetAmount2 = Currency.new(1n, adaAssetInfo);
